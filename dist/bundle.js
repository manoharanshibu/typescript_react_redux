...
/***/ function(module, exports, __webpack_require__) {
	...
	var contactus_1 = __webpack_require__(52);
	...
	window.addEventListener('DOMContentLoaded', function () {
	    ...
	    if (rootEl) ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store }, React.createElement(contactus_1.ContactUs, null)), rootEl);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	    return {
	        load: function load() {
	            return dispatch(actions_1.loadData());
	        },
	        save: function save(message) {
	            return dispatch(actions_1.saveData({ message: message }));
	        }
	    };
	};
	
	var ContactUsComponent = function (_React$Component) {
	    _inherits(ContactUsComponent, _React$Component);
	    ...
	    function ContactUsComponent() {
	        ...
	        _this._onClickSave = function (e) {
	            ...
	            if (!_this.props.isSaving) {
	                ...
	                var message = _this.refs.message;
	                _this.props.save({ name: name['value'], email: email['value'], message: message['value'] });
	            }
	        };
	...
	exports.ContactUs = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(ContactUsComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _saveData = {
	    ...
	    success: function success(response, request) {
	        return { type: 'SAVE_DATA_SUCCESS', request: request, response: response };
	    },
	    error: function error(_error, request) {
	        return { type: 'SAVE_DATA_ERROR', request: request, error: _error };
	    }
	};
	var _loadData = {
	    request: function request(_request2) {
	        return { type: 'LOAD_DATA_REQUEST', request: null };
	    },
	    success: function success(response, request) {
	        return { type: 'LOAD_DATA_SUCCESS', request: null, response: response };
	    },
	    error: function error(_error2, request) {
	        return { type: 'LOAD_DATA_ERROR', request: null, error: _error2 };
	    }
	};
	...
	exports.saveData = apiActionGroupFactory(_saveData, api_1.api.save);
	exports.loadData = function () {
	    return apiActionGroupFactory(_loadData, api_1.api.load)(null);
	};
...
/***/ function(module, exports) {
	...
	exports.api = {
	    ...
	    load: function load() {
	        return flakify(function () {
	            var storedValue = JSON.parse(localStorage.getItem('__dataValue'));
	            return {
